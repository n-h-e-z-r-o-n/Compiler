...
class C_grammarListener(ParseTreeListener):
    ...
    def enterCondition_statement_RFC(self, ctx:C_grammarParser.Condition_statement_RFCContext):
        pass

    # Exit a parse tree produced by C_grammarParser#condition_statement_RFC.
    def exitCondition_statement_RFC(self, ctx:C_grammarParser.Condition_statement_RFCContext):
        pass
